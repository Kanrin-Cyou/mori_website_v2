...
export default function Home(){
    ...
    const legalContract = [
        ...
        {
            title:'料金例',
            note:'■ 顧問企業社員雇用管理関連が中心の場合…月額22,000円(税込)',
            note2:'■ 顧問企業営業案件の後方支援等を含む場合…月額33,000円(税込)',
        },
    ]
        ...
        <Box>
            ...
            >
                <Container sx={{pt:8}}>
                    ...
                    data-aos-duration="1000"
                    >
                            当事務所は都営新宿線新宿三丁目駅のそばにある総合事務所です。2006年の開業以来、入管業務、企業法務等を中心に事業を行っております。税理士、司法書士、社会保険労務士各事務所と緊密に連携しており、多くの事例に即応できます。
                            <br/>
                            <br/>
                            入管業務では、個々の申請案件の他、顧問先不動産会社様等への継続的な営業支援業務を行っております。例えば、不動産投資に伴い必要な入管情報・手続を、顧問先企業やその取引先法人・個人に提供しています。
                            <br/>
                            <br/>
